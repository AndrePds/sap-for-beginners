...
-- All tables are  CREATE OR REFRESH LIVE TABLE  (batch – not streaming).
...
CREATE OR REFRESH LIVE TABLE kpi_revenue_by_customer_month
...
CREATE OR REFRESH LIVE TABLE kpi_order_to_cash
...
CREATE OR REFRESH LIVE TABLE kpi_purchase_spend_by_vendor
...
CREATE OR REFRESH LIVE TABLE kpi_nota_fiscal_tax_summary
